...
export const pasosMicrosoft: PasoRoadmap[] = [
  { id: 'p1', titulo: 'Aplicación enviada', fecha: '2025-03-10', descripcion: 'CV enviado via LinkedIn. Versión 2.1 - Cloud Focus.', estado: 'completado' },
  ...
  { id: 'p3', titulo: 'Technical Screen', fecha: '2025-03-28', descripcion: 'Entrevista técnica con el equipo de Azure. DSA + System Design.', estado: 'completado' },
  { id: 'p4', titulo: 'Loop Interview (x4)', fecha: '2025-04-10', descripcion: '4 entrevistas en un día. Behavioral, System Design, Coding, Team Fit.', estado: 'pendiente' },
  { id: 'p5', titulo: 'Oferta', descripcion: 'Esperar oferta formal del equipo de compensación.', estado: 'pendiente' },
  { id: 'p6', titulo: 'Negociación', descripcion: 'Negociar salario, equity y signing bonus.', estado: 'pendiente' },
  { id: 'p7', titulo: 'Cierre', descripcion: 'Firma de contrato y onboarding.', estado: 'pendiente' },
];
...
export const kanbanCols = ['recibida', 'aplicada', 'pendiente', 'rechazada_yo', 'rechazada_empresa', 'ignorada'] as const;

export const estadoLabels: Record<string, string> = {
  recibida: 'Recibida',
  aplicada: 'Aplicada',
  pendiente: 'Pendiente',
  rechazada_yo: 'No continué',
